...
use solana_pay_kit::mpp::protocol::core::headers::parse_authorization;
use solana_pay_kit::mpp::protocol::intents::ChargeRequest;
use solana_pay_kit::mpp::server::{html, Config, Mpp};
...
async fn fortune(
    ...
    let challenge = mpp
        ...
        .expect("charge");
    let www_auth = solana_pay_kit::mpp::format_www_authenticate(&challenge).unwrap_or_default();
